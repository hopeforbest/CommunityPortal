...
<body>
 ...
 <div class="container ">
    	<form  id="loginform" class=" cent regiForm" action="" method="post" >
            <center><h5 style="color:white">Confirm your Data</h5></center><br>
			<div id="err"></div>
			...
			<div class="col-md-9">
				...
				<div class="form-group" >
					...
					<div class="col-md-6">
						<input type="text" class="form-control input-md" id="txt_FirstName"  name="FirstName" value="<?php echo $fn; ?>" ><br>
					</div>
				</div>
				</div>	
				...
				<div class="form-group " >
					<label for  ="txt_password" class="control-label col-md-3" col-form-label>Password</label>
						<div class="col-md-6">
							<input type="password" class="form-control input-md" id="txt_password"  name="Password" value="<?php echo $_SESSION['password'];?>" ><br> 
           				</div>
				</div>
				</div>							
				<div class="row">
